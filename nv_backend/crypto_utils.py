...
if __name__ == '__main__':
    aes = AESCipher('天龙啊!@#$0Oo')
    a = aes.encrypt('你好12331131313131243442342342343223423123123123-aes')
    b = aes.decrypt(a)
    print(a, b)
    ...
    m = rsa.encrypt("你好12331131313131243442342342343223423123123123-rsa")
    n = rsa.decrypt(m)
    print(m, n)

    des3 = TripleDES('天龙啊!@#$0Oo')
    x = des3.encrypt("你好12331131313131243442342342343223423123123123-3des")
    y = des3.decrypt(x)
    print(x, y)
